...
//        float capacidadCarga = Float.parseFloat(jTextField4.getText());
        Array<Integer> capacidadCarga = null;
        String capacidad = jTextField2.getText();
        String[] numbers = capacidad.split(",");
        for (int i = 0; i < numbers.length; i++) {
            capacidadCarga.add(Integer.valueOf(numbers[i]));
        }
...
//                upb.sgttp.model.domain.Main.modifyListTrains(list);
            ...
            Train train = new Train(nombre, upb.sgttp.model.domain.Main.createId(tipo), kilometros, capacidadCarga, marca, new Array(1), new Array(1), true);
            list.add(train);
            upb.sgttp.model.domain.Main.modifyListTrains(list);
...
//            upb.sgttp.model.domain.Main.chargeTrains();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if (selectedRow != -1) {
            ...
            String capacidad = jTextField2.getText();
            String[] numbers = capacidad.split(",");
            Array<Integer> capacidadCarga = new Array(numbers.length);
            for (int i = 0; i < numbers.length; i++) {
                capacidadCarga.add(Integer.valueOf(numbers[i]));
            }
